...
> salmon-domain evidence rather than decisions. Most of the findings those
> comments mark are recorded, some of them corrected, in
> salmon-knowledge-commons, whose `concepts/index.md` lists the cards.
