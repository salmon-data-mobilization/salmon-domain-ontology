# ADR-0005: Sockeye life-history types, and no species vocabulary
...
> commit `949ed95`). It is the part that mints the Sockeye life-history types
> and `smn:hasLifeHistory`. It also carries, verbatim, the statements the
> combined ADR made about the whole proposal (its size, its open questions,
> its sources and its rulings), because they were written about all four parts
...
> evidence rather than decisions. Most of the findings those comments mark are
> recorded, some of them corrected, in salmon-knowledge-commons, whose
> `concepts/index.md` lists the cards. Knowledge-log entries dated 2026-08-17
> and 2026-08-25 that cite ADR-0003 mean the combined ADR, not this file.
>
...
<!-- commons-evidence E04 begin: salmon-domain evidence, not a decision (WoRMS AphiaID 254569 (Oncorhynchus nerka) and its RDF content negotiation); a candidate for salmon-knowledge-commons -->
...
<!-- commons-evidence E04 end -->

The reasons the species *scheme* was withdrawn are unchanged and still hold,
so they are kept rather than rewritten:

<!-- commons-evidence E02 begin: salmon-domain evidence, not a decision (steelhead has no taxonomic identifier in ITIS, WoRMS, NCBI, GBIF or Catalogue of Life); a candidate for salmon-knowledge-commons -->
...
<!-- commons-evidence E03 begin: salmon-domain evidence, not a decision (taxonomic authorities disagree about cutthroat taxa); a candidate for salmon-knowledge-commons -->
...
> **Split note.** The argument for the two axis-property names, and for minting
> no generic axis-value property, is in ADR-0004, whose part mints those
> properties.
...
> **Split note.** The table's last row is ADR-0006's scheme, minted by a
> separate part. This part, stacked on ADR-0004's, adds the third row.
...
<!-- commons-evidence E07 begin: salmon-domain evidence, not a decision (the duration and rearing-habitat axes cross-classify the three sockeye types); a candidate for salmon-knowledge-commons -->
...
<!-- commons-evidence E08 begin: salmon-domain evidence, not a decision (the chinook ocean-/stream-type bundle is not stable across the species range); a candidate for salmon-knowledge-commons -->
...
<!-- commons-evidence E08 end -->

<!-- commons-evidence E09 begin: salmon-domain evidence, not a decision (DFO declined to split chinook CUs by type because populations are mixtures); a candidate for salmon-knowledge-commons -->
...
> **Split note.** Decision 6's other application, the even-year cycle line, is
> in ADR-0006. Its paragraph on ADR-0002's age classes is in ADR-0003, with the
> rule.
...
> **Split note.** The `PKO` and `PKE` rows name ADR-0006's concepts, which a
> tree carrying only this part and the parts beneath it does not contain.
...
<!-- commons-evidence E17 begin: salmon-domain evidence, not a decision (SER covers river- and ocean-/sea-type sockeye: data dictionary, CU lookup, SAR 2022/003, the residual rule); a candidate for salmon-knowledge-commons -->
...
<!-- commons-evidence E18 begin: salmon-domain evidence, not a decision (sea type originates in Gilbert 1913's sockeye section; ocean-type's broad and narrow DFO senses); a candidate for salmon-knowledge-commons -->
...
> **Split note.** The first row of this table concerns ADR-0006's terms, and the
> third row concerns ADR-0004's axis terms as well as this part's.

<!-- commons-evidence E20 begin: salmon-domain evidence, not a decision (who coined the sea-type, river-type and lake-type labels; the bibliography-hit lesson); a candidate for salmon-knowledge-commons -->
...
> **Split note.** The counts in these consequences are the combined proposal's.
> On module 07, this part and ADR-0004's together take it from 10 schemes and 49
> concepts to 13 and 59; ADR-0006's part adds the fourteenth scheme and three
> more concepts.
...
<!-- commons-evidence E21 begin: salmon-domain evidence, not a decision (DFO's LIFE_HISTORY_TYPE labels every SER row River Type); a candidate for salmon-knowledge-commons -->
...
> **Split note.** `smn:CycleLineScheme` is ADR-0006's.
...
<!-- commons-evidence E22 begin: salmon-domain evidence, not a decision (sources group sea- and river-type against lake-type as a nesting; the sea/river ecotype); a candidate for salmon-knowledge-commons -->
...
> **Split note.** Open question 2, the cycle-line scheme's name, is in ADR-0006.
...
<!-- commons-evidence E23 begin: salmon-domain evidence, not a decision (sources read and not read for the 2026-08-25 revision); a candidate for salmon-knowledge-commons -->
